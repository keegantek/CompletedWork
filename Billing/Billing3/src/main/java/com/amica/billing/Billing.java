...
import com.amica.esa.componentconfiguration.manager.ComponentConfiguration;
...
public class Billing {
	...
	public static final String CUSTOMERS_FILE = "Billing.customersFile";
	public static final String INVOICES_FILE = "Billing.invoicesFile";
	...
	/**
	 * Build a Billing object based on a Configuration object
	 */
	public Billing(Configuration configuration) {
		this(configuration.getString(CUSTOMERS_FILE), configuration.getString(INVOICES_FILE));
//		System.out.println("CONFIG! Customer File" + configuration.getString(CUSTOMERS_FILE));
	}

	/**
	 * Build a Billing object based on the Billing Configuration
	 */
	public Billing() {
	...
	public Billing(String customersFilename, String invoicesFilename) {
		...
		System.out.println("CUSTOMERS FILENAME " + customersFilename);
