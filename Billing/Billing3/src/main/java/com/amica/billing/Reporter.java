...
public class Reporter {
	...
	public static final String OUTPUT_FOLDER = "Reporter.outputFolder";
	public static final String AS_OF = "Reporter.asOfDate";

	public Reporter(Configuration config) {
		this(new Billing(config), config.getString(OUTPUT_FOLDER), LocalDate.parse(config.getString(AS_OF)));
	}
	 ...
	 */
	public Reporter(Billing billing, String pathToFolder, LocalDate asOf) {
		this.billing = billing;
		this.outputFolder = Paths.get(pathToFolder);
		this.asOf = asOf;
		
		if (!outputFolder.toFile().exists()) {
			log.warning(() -> "Output folder " + outputFolder + " does not exist.");
		}
