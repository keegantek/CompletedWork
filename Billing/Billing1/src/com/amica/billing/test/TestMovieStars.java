...
public class TestMovieStars {
	...
	public static void testParser() {
		...
		Customer customer = new Customer("Edward", "Brophy", Customer.Terms.CASH);
	...
	public static void testBilling() {
		...
		assertEqual(customers.get(EXPECTED_CUSTOMER).getTerms(), Customer.Terms.CREDIT_60,
	...
	public static void testReporter() {
		...
		billing.createCustomer("Lionel", "Barrymore", Customer.Terms.CASH);
